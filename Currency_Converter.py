...
headlabel = tk.Label(Tops, font=('lato black', 19, 'bold'), text='    *** Welcome to Currency converter - By Tanay Choubey ***',
                    bg='#e6e5e5', fg='black')
...
Label_9 = Button(root, font=('arial', 15, 'bold'), text="   Convert  ", padx=2, pady=2, bg="lightblue", fg="red",
